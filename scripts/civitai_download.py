...
def download_file(url, file_path, install_path, model_id, progress=gr.Progress() if queue else None):
    try:
        ...
        if not download_link:
            ...
            print(f'File: "{file_name}" requires a personal CivitAI API to be downloaded, you can set your own API key in the SD CivitAI Browser+ NEO settings in the SD-WebUI settings tab')
            gl.download_fail = "NO_API"
            if progress != None:
                progress(0, desc=f'File: "{file_name}" requires a personal CivitAI API to be downloaded, you can set your own API key in the SD CivitAI Browser+ NEO settings in the SD-WebUI settings tab')
                time.sleep(5)
            return
...
def download_file_old(url, file_path, model_id, progress=gr.Progress() if queue else None):
    try:
        ...
        if not download_link:
            ...
            print(f'File: "{file_name_display}" requires a personal CivitAI API key to be downloaded, you can set your own API key in the SD CivitAI Browser+ NEO settings in the SD-WebUI settings tab')
            gl.download_fail = "NO_API"
            if progress != None:
                progress(0, desc=f'File: "{file_name_display}" requires a personal CivitAI API key to be downloaded, you can set your own API key in the SD CivitAI Browser+ NEO settings in the SD-WebUI settings tab')
                time.sleep(5)
            return
