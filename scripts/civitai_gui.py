...
def on_ui_tabs():    
    ...
    if ver_bool:
        tab_name = "SD CivitAI Browser+ NEO"
    else:
        tab_name = "SD CivitAI Browser+ NEO"
...
def on_ui_settings():
    if ver_bool:
        ...
        categories.register_category("civitai_browser_plus", "SD CivitAI Browser+ NEO")
        cat_id = "civitai_browser_plus"
    else:
        section = ("civitai_browser_plus", "SD CivitAI Browser+ NEO")
